...
export function RecommendationsBlock() {
    ...
    return (
        <section id="recommendations" className="w-full bg-white py-20 sm:py-28 relative border-t border-gray-100">
                ...
                <div className="mb-12 text-center md:mb-16">
                    <FadeIn direction="up" delay={0}>
                        <span className="mb-4 inline-flex items-center gap-2 rounded-full bg-gray-50 px-4 py-1.5 text-[10px] font-bold tracking-widest text-gray-600 uppercase shadow-sm border border-gray-200">
                            <Award className="h-3.5 w-3.5 text-yellow-500" /> {t("RecommendationsBlock.badge")}
                        </span>
                    </FadeIn>

                    <FadeIn direction="up" delay={150}>
                        <Heading className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl">
                            {t("RecommendationsBlock.headingStart")} <br className="hidden sm:block" />
                            <span className="text-primary-600">{t("RecommendationsBlock.headingAccent")}</span>
                        </Heading>
                    </FadeIn>
